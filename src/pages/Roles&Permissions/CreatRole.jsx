...
function CreateRole() {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-evenly p-4 font-sans text-[#CCCCCC]">
       ...
       <motion.div
        ...
        >
            ...
            >
                Create The First Role in System
            </motion.h2>
            ...
            >
                "Create the first role in the system. 
                Assign the required permissions from the list, and once you are finished, click 'Next'."
            </motion.p>
                <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
