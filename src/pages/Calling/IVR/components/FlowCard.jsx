  ...
  return (
    <div
      ...
      hover:border-[#0D9EF2]/50 transition-all duration-300 ease-in-out 
        shadow-lg hover:shadow-[#0D9EF2]/5 flex flex-col justify-between h-full cursor-pointer"
    >
      ...
      <div>
        ...
        <p className="text-slate-400 text-sm leading-relaxed mb-6 line-clamp-2">
          {flow.description || t('flowCard.noDescription')}
        </p>
      </div>
